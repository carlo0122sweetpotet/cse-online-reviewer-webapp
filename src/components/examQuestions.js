  ...
  analytical: {
    1: { // Logical Reasoning Test
      questions: [
        ...
        {
          id: 4,
          question: "Computer : fqprxvht :: Language : ?",
          options: ["ocqixcig", "oxpixdig", "ocqicyig", "ocqixcjg"],
          correctAnswer: 0,
          explanation: ""
        },
        {
          id: 5,
          question: "Genuine : Authentic :: Mirage : ? ",
          options: ["Illusion", "Image", "Hideout", "Reflection"],
          correctAnswer: 0,
          explanation: ""
        },
        {
          id: 6,
          question: "SECLUSION : HERMIT :: ? : ?",
          options: ["wealth : embezzler", "ambition : philanthropist", "domination : athlete", "turpitude : introvert", "injustice : lawyer"],
          correctAnswer: 0,
          explanation: ""
        },
        {
          id: 7,
          question: "philanthropist : munificence :: ? : ?",
          options: ["aristocrat : gratitude", "skeptic : disbelief", "symptom : treatment", "anomaly : plausibility", "cynic : melancholy"],
          correctAnswer: 1,
          explanation: "Degree of intensity. Philanthropist is a generous person while munificence is extremely generous. As skeptic is inclined to question or doubt accepted opinions while disbelief is refusal to accept that something is true"
        },
        {
          id: 8,
          question: "Vague : Nebulous :: ? : ?",
          options: ["spectacular : legitimate", "mundane : commonplace", "magical : impressive", "steep, shallow"],
          correctAnswer: 1,
          explanation: "Something vague is nebulous. Something mundane is commonplace"
        },
        {
          id: 9,
          question: "Diaphanous : Opaque :: ? : ?",
          options: ["dischevelled : messy", "disconsolate : happy", "disrespectful : injurious", "disallow : reject", "distraught : calm"],
          correctAnswer: 4,
          explanation: "Disaphanous is the opposite of opaque. Distraught is the opposite of calm"
        },
        {
          id: 10,
          question: "FRAME : PICTURE",
          options: ["display : museum", "shelf : refrigirator", "mechanic : electrician", "nail : hammer", "fence : backyard"],
          correctAnswer: 4,
          explanation: "A frame surrounds a picture; a fence surrounds a backyard"
        },
        {
          id: 11,
          question: "SEARCH : FIND",
          options: ["sleep : wake", "explore : discover", "draw : paint", "think : relate", "walk : run"],
          correctAnswer: 1,
          explanation: "One searches in order to find; one explores in order to discover"
        },
        {
          id: 12,
          question: "PHARMACY : DRUGS",
          options: ["mall : store", "doctor : medicine", "bakery : bread", "supermarket : discount store", "toys : games"],
          correctAnswer: 2,
          explanation: "A pharmacy sells drugs; a bakery sells bread"
        },
        {
          id: 13,
          question: "LAYER : TIER",
          options: ["section : segment", "dais : speaker", "curtain : stage", "chapter : verse", "cotton : bale"],
          correctAnswer: 0,
          explanation: "Layer and tier are synonyms; section and segment are synonyms"
        },
        {
          id: 14,
          question: "Children are in pursuit of a dog whose leash has broken. James is directly behind the dog. Ruby is behind James. Rachel is behind Ruby. Max is ahead of the dog walking down the street in the opposite direction. As the children and dog pass, Max turns around and joins the pursuit. He runs in behind Ruby. James runs faster and is alongside the dog on the left. Ruby runs faster and is alongside the dog on the right. Which child is directly behind the dog?",
          options: ["James", "Ruby", "Rachel", "Max"],
          correctAnswer: 3,
          explanation: ""
        },
        {
        ...
        {
          id: 17,
          question: "Statement: In the recently held all Philippine Nursing conference, the season on 'Vacination Campaign' surprisingly attracted a large number of participants and also received very good media coverage.\n Assumptions: I. Media is always very positive towards the Service sector.\n II. The service sector is managed properly in Philippines. \n III. People weren't expecting such an encouraging response to the service sector conference.",
          options: ["I, II, and III", "I and III", "I and II", "II and III", "III only"],
          correctAnswer: 4,
          explanation: ""
        }
      ]
    ...
    6: { // Basic Mathematics
      questions: [
        ...
        },
        {
          ...
          options: ["8", "16", "4", "32"],
          correctAnswer: 1,
          explanation: "(2×1÷2), (4÷1×2), (6×1÷2), (8×1÷2) Since (8÷1×2) is not found in the choices, so we have to solve this. (8÷1×2) = 16"
        },
        {
          id: 4,
          ...
          options: ["4", "3", "8", "2"],
          correctAnswer: 0,
          explanation: "(15-8+3), 8, (4÷2×3),___  10, 8, 6, 4"
        },
        {
          id: 5,
          question: "Simplify: 33 1/3 % of 48 + 12 ½ % of 96 – 44 4/9 % of 27",
          options: ["12", "16", "24", "48"],
          correctAnswer: 1,
          explanation: ""
        },
        {
          ...
          options: ["9.6", "8", "9", "10", "8.6"],
          correctAnswer: 0,
          explanation: "12 = 1.25 × N 12/1.25 = N = 9.6"
        },
        {
          id: 7,
          question: "What percent of 16 is 40?",
          options: ["2.5%", "2500%", "1/4", "250%", "25%"],
          correctAnswer: 3,
          explanation: "N × 16 = 40 N = 40/16 = 2.5×100% = 250%"
        },
        {
          id: 8,
          ...
          correctAnswer: 0,
          explanation: "4/5 – 5/4 = 16/20 – 25/20 = –9/20"
        },
        {
          id: 9,
          question: "What is the ratio of ¼ to 3/5?",
          options: ["1 : 3 ", "3 : 20", "5 : 12", "3 : 4", "5 : 4"],
          correctAnswer: 2,
          explanation: "0.25 : 0.6 = 25:60 = 5:12"
        },
        {
          id: 10,
          question: " What is the difference between √150 and √54?",
          options: ["3 √6 ", "16 √6 ", " √96 ", "6 √2", "2 √6"],
          correctAnswer: 4,
          explanation: "√150 –√54 = √(25×6) √(9×6) = 5√6 3√6 = 2√6"
        }
      ]
    },
  ...
  general: {
    8: { // Philippine History and Culture
      questions: [
        ...
        {
          id: 3,
          question: "The official motto used in 30th Southeast Asian Games is what?",
          options: ["We Care As One", "We Play As One", "We Win As One", "We Will As One", "We Work As One"],
          correctAnswer: 2,
          explanation: ""
        },
        {
          id: 4,
          question: "On August 16, 2018, the government announced at least ____ Philippine holidays for 2019 as declared by virtue of Proclamation No. 555, series of 2018.",
          options: ["16", "18", "19", "15", "14"],
          correctAnswer: 1,
          explanation: ""
        },
        {
          id: 5,
          question: "Which of the following statements best describes the relationship between global warming ozone depletion?",
          options: ["Ozone depletion contributes to global warming", "Global warming causes ozone depletion", "Ozone depletion and global warming have nothing to do with each other", "Excessive build-up of carbon dioxide causes both global warming and ozone depletion."],
          correctAnswer: 0,
          explanation: ""
        },
        {
          id: 6,
          question: "It is only Philippine province with an English name.",
          options: ["Cebu", "Mountain Province", "General Santos", "Zambales"],
          correctAnswer: 1,
          explanation: ""
        },
        {
          id: 7,
          question: "What form of government does the Philippines adopt?",
        ...
        {
          id: 8,
          question: "Who among the following may issue a warrant of arrest or a search warrant?",
          options: ["Senator", "Judge", "Congressman", "The President"],
          correctAnswer: 1,
          explanation: ""
        },
        {
          id: 9,
          question: "A foreigner may acquire Filipino citizenship through",
          options: ["Naturalization", "Extradition", "Rebirth", "Visa application"],
          correctAnswer: 0,
          explanation: ""
        },
        {
          id: 10,
          question: "What is regarded by the State as a 'primary social economic force?'",
          options: ["Education", "Trade", "Labor", "Commerce"],
          correctAnswer: 2,
          explanation: ""
        },
        {
          id: 11,
          question: "According to Article III, Section 15 of the constitution, the writ of habeas corpus may be suspended in times of rebellion or what?",
          options: ["martial law", "war", "terrorism", "invasion"],
          correctAnswer: 3,
          explanation: ""
        },
        {
          id: 12,
          question: "The Lower Chamber of the Congress of the Philippines is known by what name?",
          options: ["Senate", "Congressional Lower Chamber", "National Assembly", "House of Representatives"],
          correctAnswer: 3,
          explanation: ""
        },
        {
          id: 13,
          question: "A Member of either house of Congress may be expelled by their fellow Members. For a Member to be expelled, how much of the total number of Members of a house must concur with the expulsion?",
          options: ["two-thirds", "majority", "three-fourths", "nine-tenths"],
          correctAnswer: 0,
          explanation: ""
        },
        {
          id: 14,
          question: "If a President wishes to veto a bill, he/she must communicate it within a certain span of time, otherwise the bill will become a law. How long is this span of time?",
          options: ["3 weeks", "48 days", "60 days", "80 days"],
          correctAnswer: 3,
          explanation: ""
        },
        {
          id: 15,
          question: "What project of the DENR that includes the protection of Industrial pollution of our Environment?",
          options: ["Bantay Kalikasan", "Bantay Ilog", "Bantay Dagat", "Ecological Watch", "Solid Waste Management"],
          correctAnswer: 3,
          explanation: ""
        }
      ]
    ...
    9: { // Current Affairs
      questions: [
        ...
        },
        {
          ...
          correctAnswer: 0,
          explanation: "Andres Bonifacio is called the 'Father of the Philippine Revolution' for founding the Katipunan."
        },
        {
          id: 3,
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation: "The Philippines gained independence from the United States on July 4, 1946."
        },
        {
          id: 5,
          ...
          correctAnswer: 2,
          explanation: "Antonio Guterres has been the Secretary-General of the United Nations since January 2017."
        },
        {
          id: 6,
          ...
          correctAnswer: 1,
          explanation: "Ferdinand Marcos declared Martial Law in the Philippines in 1972."
        },
        {
          id: 7,
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation: "The 2024 Summer Olympics were hosted by Paris, France."
        },
        {
          id: 9,
          question: "What is the national flower of the Philippines?",
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation: "Corazon Aquino was the first woman president of the Philippines, serving from 1986 to 1992."
        },
        {
          id: 12,
          ...
          correctAnswer: 1,
          explanation: "Africa is often referred to as the 'Cradle of Civilization' because early human ancestors originated there."
        },
        {
          id: 13,
          ...
          correctAnswer: 2,
          explanation: "The official currency of Japan is the Yen."
        },
        {
          id: 14,
          ...
          correctAnswer: 1,
          explanation: "Jose Rizal is considered the national hero of the Philippines."
        },
        {
          id: 15,
          question: "Which is the smallest province in the Philippines in terms of land area?",
          options: [
            "Batanes",
            "Camiguin",
            "Siquijor",
          ...
          correctAnswer: 0,
          explanation: "Batanes is the smallest province in the Philippines in terms of land area."
        }
      ]
    }
  }
