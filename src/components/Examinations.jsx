...
const Examinations = ({ user, userData, onExamCompleted }) => {
    ...
    const categories = [
        ...
        },
        {
            id: 'mock',
            title: 'Try Mock Exam',
            description: 'Complete civil service exam simulation with 100 questions',
            note: 'Note: Mock exam scores are not saved to your profile',
            disabled: true,
            icon: Award,
                    ...
                    numerical: [
                        {
                            id: 6,
                            title: 'Mathematics',
                            description: 'Arithmetic and mathematical operations',
                            duration: 'unlimited',
                            questions: 10,
                            difficulty: 'Professional Level'
                        },
                    ...
                    general: [
                        {
                            ...
                            description: 'National and cultural knowledge',
                            duration: 'unlimited',
                            questions: 15,
                            difficulty: 'Professional Level'
                        },
                        {
                            id: 9,
                            title: 'General Information and Current Affairs',
    ...
    const handleSubmitExam = async () => {
        ...
        try {
            ...
            // Only save to Firebase if it's NOT a mock exam
                ...
                {categories.map((category) => {
                    ...
                    return (
                        <div
                            ...
                            className={`bg-white rounded-xl border border-gray-200 p-6 transition-all duration-200 ${category.disabled
                                    ? 'cursor-not-allowed opacity-50'
                                    : `cursor-pointer ${category.hoverColor} hover:shadow-lg hover:border-gray-300`
                                }`}
                        >
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    {category.note && (
                                        <p className="text-sm text-orange-600 mb-4 italic">{category.note}</p>
                                    )}
                                    {category.disabled && (
                                        <p className="text-sm text-red-600 mb-4 font-medium">Coming Soon</p>
                                    )}
