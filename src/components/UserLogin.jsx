        ...
        try {
            ...
            if (userData.registeredIP && userData.registeredDevice) {
                ...
                if (isIPDifferent || isDeviceDifferent) {
                    console.log('Device/IP mismatch detected, showing modal');
                    ...
                    <div className="space-y-6">
                        ...
                        {deviceMismatchError && (
                            <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                <p className="text-yellow-700 text-sm">{deviceMismatchError}</p>
                            </div>
                        )}
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 mb-2">Device/Location Mismatch</h3>
                            <p className="text-gray-600 mb-6">
                                {deviceMismatchError}
                            </p>
                            <button
